...
const SurfBot = () => {
  return (
    <div
      ...
      className="  h-[372px]   rounded-lg pt-24 relative  xlg:mt-24 mt-44 lg:mx-0 mx-1 "
    >
      ...
      <div className=" container">
        ...
        <div className=" max-w-[750px] mx-auto text-center flex flex-col gap-6 justify-center items-center  ">
          ...
          <p className=" italic text-white xlg:text-[36px] md:text-[24px] text-[16px] font-[400] uppercase -mt-4 cursor-pointer   ">
            The next wave of trading starts here.
          </p>

          <Link href={`#`} className="bg-[#FFF] z-50 flex gap-[10px] py-3 px-6 shadow-custom rounded-[8px] transition-all duration-300 hover:opacity-85 cursor-pointer">
